(function () {
  ...
  */
  ...
  var cpfs = ['049-214 3421-1', '210.458.522-05', '735 500 794 - 22',
    '101.123-131x32'
  ];
  ...
  */
  ...
  var RegExp = /(<\w+>)|(<\/\w+>)/g;
  var matches_arr = frase.match(RegExp);

  console.log (matches_arr[0] + 'O texto dentro da tag "h1" é "Título da página' + matches_arr[1]);
  console.log (matches_arr[2] + 'O texto dentro da tag "p" é "Este é um parágrafo' + matches_arr[3]);
  console.log (matches_arr[4] + 'O texto dentro da tag "p" é "Este é um parágrafo' + matches_arr[5]);
    */
