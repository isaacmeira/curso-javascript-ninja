...
text = text.replace(/Manuel Marques de Sousa/, 'Isaac Meira');
console.log(text);
// ?
...
text = text.replace(/brasileiro/ , 'Manhuaçuense');
console.log(text);
...
console.log ('O mes de março é representando pelo número ' + getMonthNumber('março'))
console.log ('O mes de setembro é representando pelo número ' + getMonthNumber('setembro'))
console.log ('O mes de desembro é representando pelo número ' + getMonthNumber('dezembro'))
